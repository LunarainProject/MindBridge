  ...
  public static async initAsync(): Promise<void> {
    if(__DEV__) {
      ...
      await GoogleSignIn.initAsync({
        clientId: "373996144704-20tcboru7a7e04ud6aeigm0r173m07g5.apps.googleusercontent.com",
      });
    }
  }

  public static async autoSignInAsync(): Promise<{ user: Google.GoogleUser | null, idToken: string | null}> {
    if(__DEV__) {
      return {
        user: null,
        idToken: null
